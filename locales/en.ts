...
const en: Record<string, string> = {
  ...
  'home.live_count': '{{count}} listening right now',
  ...
  'home.preview_listening': 'Listening...',
  'home.friend_in_room': '{{name}} is here',
  'home.follow_failed': 'Could not follow room.',
  'home.soprano_lobi': 'SOPRANO LOBBY',
  'home.lobi_subtitle': '🎵 Listen, meet, chat',
  'home.lobi_listeners': '{{count}} listening · 24/7 open',
  'home.featured_users': 'FEATURED USERS',
  'home.upcoming_rooms': 'Upcoming Rooms',
  'home.planned_count': '{{count}} planned',
  'home.just_now': '🟢 Just now',
  'home.minutes_ago': '{{diff}}m ago',
  'home.room_count': '{{count}} rooms',
  'home.your_friend': 'Your friend',
  'home.hidden_rooms': '{{count}} hidden rooms',
  'category.chat': 'Chat',
  ...
  'category.all': 'All',
  // ★ v1.7.13.116 TR cultural categories (kept TR labels for authenticity)
  'category.tsm': 'Turkish Art Music',
  'category.arabesk': 'Arabesk',
  'category.halk': 'Folk Music',
  'category.pop': 'Pop & Rap',
  'category.magazin': 'Tabloid',
  'category.spor': 'Sports',
  'category.edebiyat': 'Literature',
  'category.tarih': 'History',
  'category.yemek': 'Food',
  'category.sanat': 'Art',
  'category.seyahat': 'Travel',
  'create.cat.tsm.desc': 'Classic Turkish art music nights.',
  'create.cat.arabesk.desc': 'Sorrow, love, soul — arabesque classics.',
  'create.cat.halk.desc': 'Folk songs, bağlama, Anatolian voice.',
  'create.cat.pop.desc': 'Pop, rap, indie scene.',
  'create.cat.magazin.desc': 'Trending stories and gossip.',
  'create.cat.spor.desc': 'Match talk, fans, transfers.',
  'create.cat.edebiyat.desc': 'Book club, authors, poetry.',
  'create.cat.tarih.desc': 'Ottoman, Republic, world history.',
  'create.cat.yemek.desc': 'Recipes, restaurants, home cooking.',
  'create.cat.sanat.desc': 'Painting, sculpture, gallery, studio.',
  'create.cat.seyahat.desc': 'Routes, trips, camping, nature.',
  'filter.open': 'Open',
  ...
  'rooms.persistent': 'Persistent',
  'rooms.not_started': 'Not started',
  'rooms.closed_state': 'Closed',
  'myrooms.section.not_started': 'Not Started',
  'myrooms.section.passive_persistent': 'Idle Persistent Rooms',
  'myrooms.section.closed': 'Closed Rooms',
  ...
  'myrooms.section.passive_persistent_alt': 'Passive Persistent Rooms',
  ...
  'messages.browse_rooms': 'Browse rooms →',
  ...
  'profile.invited_friends': 'MY INVITES',
  'profile.invite_empty': 'You haven\'t invited anyone yet.',
  'profile.invite_hint': 'Share your code — earn +50 SP for each invite.',
  'profile.code_label': 'Code',
  'profile.share_message': 'Discover {{0}}\'s profile on SopranoChat:\n{{1}}',
  ...
  'profile.boost_plus_required': 'Plus membership required',
  'profile.stat_friend': 'Friend',
  'profile.stat_room': 'Room',
  'profile.stat_badge': 'Badge',
  'profile.stat_gift': 'Gift',
  'profile.stats_label': 'STATS',
  'profile.stats_stage_min': 'Stage Min',
  'profile.stats_rooms_created': 'Rooms Hosted',
  'profile.stats_total_listeners': 'Listeners',
  'profile.stats_total_reactions': 'Reactions',
  'profile.invite_code_accepted': 'Invite code accepted.',
  'profile.invite_code_rejected': 'Code Not Accepted',
  'profile.use_invite_code_btn': 'Use Code (+50 SP)',
  ...
  'room.lock.locked': '🔒 Oda Kilitlendi',  // TODO: translate
  'room.mode.free_for_all': 'Serbest Mod',  // TODO: translate
  ...
  'auto.store.collection.id.013': "MİTİK",  // TODO: translate
  ...
  'auto.store.042': "MİTİK",  // TODO: translate
  ...
  'auto.store.StoreItemPreviewSheet.011': "MİTİK",  // TODO: translate
  ...
  // ── Boost ──────────────────────────────────────────
  'boost.plus_required_title': 'Plus required',
  'boost.plus_required_msg': 'Profile boost feature requires Plus membership.',
  'boost.activated_title': 'Boost active',
  'boost.activated_msg': 'Your profile will be featured for {{duration}} hours.',
  'boost.error_title': 'Boost error',
  'boost.error_msg': 'Operation could not be completed.',

  // ── Time ──────────────────────────────────────────
  'time.hours_minutes': '{{hr}}h {{mn}}m',
  'time.minutes_short': '{{mn}} min',
  'time.from_now': ' from now',

  // ★ Auto-added missing keys (22 May 2026)
  'chat.camera_permission_needed': 'Camera permission required',
  'chat.gif_no_results': 'No results found',
  'chat.gif_search_placeholder': 'Search GIFs...',
  'chat.gif_trending_empty': 'Loading GIFs...',
  'chat.id.delete_chat_title': 'Delete Chat',
  'chat.id.mute': 'Mute',
  'chat.id.unblock_confirm': '{{0}} will be unblocked.',
  'chat.new_messages': '{{count}} new messages',
  'chat.no_more_messages': 'Start of conversation',
  'chat.today': 'Today',
  'chat.yesterday': 'Yesterday',
  'discover.boosted_fallback_name': 'Anonymous',
  'discover.donor_donated': 'donated SP',
  'discover.donor_label': 'TOP DONOR',
  'discover.donor_subtext': 'Most generous user today',
  'discover.empty_hint': 'Official theme rooms and new members are above — open a room from My Rooms and get the party started.',
  'discover.empty_title': 'The stage is warming up',
  'discover.sched_soon': 'Soon',
  'filter.age': '18+',
  'filter.invite': 'Invite Only',
  'filter.my_lang': 'My Language',
  ...
  'tabs.myrooms.029': 'Setting Could Not Be Saved',
  'tabs.myrooms.030': '🗑 Room Deleted',
  'tabs.myrooms.031': 'Room Could Not Be Deleted',
  'tabs.myrooms.032': '❄️ Room Frozen',
  'tabs.myrooms.033': 'Search rooms...',
  'tabs.myrooms.034': 'Chat',
  'tabs.myrooms.035': 'Game',
  'tabs.myrooms.036': 'Podcast',
  'tabs.myrooms.037': 'Room',
  'tabs.myrooms.038': 'Someone',
  'tabs.myrooms.039': '{{0}} left',
  'tabs.myrooms.040': 'Wake-up: {{0}}',
  'tabs.myrooms.041': 'Duration: {{0}}',
  'tabs.myrooms.042': 'Deleting: {{0}}',
  'tabs.myrooms.043': '{{0}}h {{1}}m',
  'tabs.myrooms.044': '{{0}}m',
  'tabs.myrooms.045': 'Your other live room will be closed. Continue?',
  'tabs.myrooms.046': 'Wake Up Room',
  'tabs.myrooms.047': 'Continue',
  'tabs.myrooms.048': 'Cancel',
  'tabs.myrooms.049': 'Are you sure you want to delete this room? This action cannot be undone.',
  'tabs.myrooms.050': 'Delete Room',
  'tabs.profile.027': 'Room boost',
  'tabs.profile.028': 'Profile boost',
  'tabs.profile.029': 'Subscription bonus',
  'tabs.profile.030': 'Boost Active',
  'tabs.profile.031': 'Your profile is featured — {{0}}.',
  'tabs.profile.032': '{{0}}h {{1}}m remaining',
  'tabs.profile.033': '{{0}} min remaining',
  'tabs.profile.034': 'Plus membership required',
  'tabs.profile.035': 'Boost active, {{0}}',


  // ★ Profile components i18n (22 May 2026)
  'badge.rarity.common': 'COMMON',
  'badge.rarity.rare': 'RARE',
  'badge.rarity.epic': 'EPIC',
  'badge.rarity.legendary': 'LEGENDARY',
  'badge.how_to_earn': 'How to Earn',
  'badge.perks_locked': 'Perks When Earned',
  'badge.perks_earned': 'Badge Perks',
  'badge.sp_reward_locked': '+{{0}} SP reward to earn',
  'badge.sp_reward_earned': '+{{0}} SP reward earned',
  'mood.title': 'Current mood',
  'mood.subtitle': 'A short sentence — everyone can see',
  'mood.placeholder': 'How are you feeling today?',
  'mood.suggestion.music': 'Listening to music',
  'mood.suggestion.reading': 'Reading a book',
  'mood.suggestion.chat': 'Open to chat',
  'mood.suggestion.energetic': 'Full of energy today',
  'mood.suggestion.quiet': 'Need some quiet time',
  'mood.clear': 'Clear',
  'mood.cancel': 'Cancel',
  'mood.saving': 'Saving...',
  'mood.save': 'Save',
  'profile.mood_placeholder': 'How are you?',
  'profile.bio_placeholder': 'Write a short bio...',
  'profile.action.frame': 'Frame',
  'profile.action.edit': 'Edit',
  'profile.action.share': 'Share',
  'profile.streak_days': '{{0}} day streak',

  // ★ Batch i18n fix (22 May 2026)
  ...
  'onboarding.interest.chat': 'Chat',
  'onboarding.interest.music': 'Music',
  'onboarding.interest.tsm': 'Turkish Classical',
  'onboarding.interest.arabesk': 'Arabesk',
  'onboarding.interest.halk': 'Folk Music',
  'onboarding.interest.pop': 'Pop & Rap',
  'onboarding.interest.film': 'Film & Series',
  'onboarding.interest.magazin': 'Celebrity',
  'onboarding.interest.spor': 'Sports',
  'onboarding.interest.edebiyat': 'Literature',
  'onboarding.interest.tarih': 'History',
  'onboarding.interest.yemek': 'Food',
  'onboarding.interest.oyun': 'Gaming',
  'onboarding.interest.tech': 'Technology',
  'onboarding.interest.sanat': 'Art',
  'onboarding.interest.seyahat': 'Travel',
  'onboarding.hello': 'Hello! 👋',
  'onboarding.about_yourself': 'Tell us about yourself',
  'onboarding.save_profile': 'Save Profile',
  'onboarding.continue': 'Continue',
  'onboarding.skip': 'Skip',
  'onboarding.apply_code': 'Apply Code',
  'onboarding.congrats': '🎉 Congrats!',
  'onboarding.code_rejected': 'Code Rejected',
  'onboarding.save_failed': 'Could not save',
  'onboarding.required_field': 'Required',
  'onboarding.guest': 'Guest',
  'onboarding.try_later': 'Please try again later.',
  'onboarding.enter_name': 'Enter a name or nickname.',
  'onboarding.max_emoji': 'You can use at most 10 emoji.',
  'onboarding.consent_title': 'Campaign & news notifications',
  'onboarding.consent_desc': 'I agree to receive emails/notifications about new features, events, and SP deals. (Optional — you can change this anytime in settings.)',
  'onboarding.alert_continue': 'Continue',
  'myrooms.password_protected': 'Private',
  'myrooms.new_room': 'Create Room',
  'leaderboard.weekly': 'Weekly',
  'leaderboard.weekly_sp_league': 'Weekly SP League',
  'notifications.today': 'Today',
  'notifications.yesterday': 'Yesterday',
  'notifications.days_ago': '{{0}}d ago',
  'messages.browse_rooms_plain': 'Browse rooms',
  'room.permission_required': '🤚 Permission Required',
  'room.permission_desc': 'Raise your hand to go on stage. You can speak once the host approves.',
  'room.selected_speakers': '🛡 Selected Speakers',
  'room.selected_speakers_desc': 'Only speakers invited by the host can talk in this room.',
  'room.banned_message': 'You have been temporarily banned from this room.',
  'room.temp_banned': 'Temporarily banned',
  'room.room_closed': 'This room has closed',
  'radio.loading': 'LOADING',
  'radio.connection_error': 'CONNECTION ERROR',
  'gift.sent_suffix': ' sent a gift',
  'editprofile.msg_privacy_open': 'Strangers can send you message requests. Friends can message directly.',
  'editprofile.msg_privacy_closed': 'Strangers cannot send new message requests. Friends can keep messaging.',
  'support.subject_too_short': 'Subject too short (at least 3 characters).',
  'support.subject_too_long': 'Subject too long (max 120 characters).',
  'support.message_too_short': 'Message too short (at least 10 characters).',
  'support.message_too_long': 'Message too long (max 2000 characters).',
  'settings.load_error': 'Failed to load settings:',
  'settings.reset_error': 'Failed to reset settings:',
  'room.invite_rejected': 'This user declined the invite. You can try again in 24 hours.',
  'gamification.open_room': '🏠 Open Your Own Room!',
  'mentor.follow_error': 'Follow Error',
  'mentor.completed': '🎉 Completed',
  'home.online': 'Online',

  // ★ RoomClosed i18n (22 May 2026)
  'room.locked': 'Room locked',
  'room.cannot_enter': 'You cannot enter this room',
  'room.retry': 'Try Again',
  'room.home': 'Home',
  'ban.expired': 'Ban expired',
  'ban.expired_hint': 'Go to home page and try entering again.',
  'ban.remaining': 'Ban expires in',
  'ban.remaining_hint': 'You can re-enter the room once the timer runs out.',
};
export default en;
