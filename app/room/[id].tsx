Warning: truncated output (original token count: 81787)
Total output lines: 6293
...
export default function RoomScreen() {
  ...
  // ★ SEC-DOUBLE-CHARGE FIX: Giriş ücreti SADECE bakiye kontrolü yapar — SP ha…31787 tokens truncated….updateLastSeen(room.id, firebaseUser.uid).catch(() => {});
